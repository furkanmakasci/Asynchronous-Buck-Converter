...
Also check out low voltage shut down network and synchronous driver which adaptive dead time(ish). Tried but, didn't have much efficiency profits.
Bad efficiency mostly caused by discrete driver circuit.
